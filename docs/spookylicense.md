...
<figure markdown>
![*ELF file type, made for Linux.*](assets/spookylicense/Untitled.png)
<figcaption>ELF file type, made for Linux.</figcaption>
</figure>
...
<figure markdown>
![*Output shows any strings with a length of 10 or greater.*](assets/spookylicense/Untitled%201.png)
<figcaption>Output shows any strings with a length of 10 or greater.</figcaption>
</figure>
...
<figure markdown>
![*The ELF file is asking us to supply a parameter of unknown length.*](assets/spookylicense/Untitled%202.png)
<figcaption>The ELF file is asking us to supply a parameter of unknown length.</figcaption>
</figure>
If we run it again, this time supplying it with any parameter, what happens?
<figure markdown>
![*An error showing ‘Invalid License Format’.*](assets/spookylicense/Untitled%203.png)
<figcaption>An error showing ‘Invalid License Format’.</figcaption>
</figure>
...
<figure markdown>
![*Default load options for Cutter.*](assets/spookylicense/Untitled%204.png)<br>
<figcaption>Default load options for Cutter.</figcaption>
</figure>
On quick inspection of this file's ‘Functions’ list, we see the main function is helpfully still named `main`. We can double click this function to display it’s contents on the right. I like to start by viewing in ‘Graph’ mode to get a decent understanding of the application flow before I investigate further. 
<figure markdown>
![*Function list of ‘spookylicence’*](assets/spookylicense/Untitled%205.png)<br>
<figcaption>Function list of ‘spookylicence’</figcaption>
</figure>
...
<figure markdown>
![*Screenshot of ‘main’ function beginning. Right side shows the interesting branch. Screenshot has been trimmed to fit.* ](assets/spookylicense/Untitled%206.png)
<figcaption>Screenshot of ‘main’ function beginning. Right side shows the interesting branch. Screenshot has been trimmed to fit.</figcaption>
</figure>
...
<figure markdown>
![*Running the program with a 32 character key and receiving a new error.*](assets/spookylicense/Untitled%207.png)
<figcaption>Running the program with a 32 character key and receiving a new error.</figcaption>
</figure>
</figure markdown>
![*The code at 0x1889 showing the error we received. This is the ‘Disassembly’ view of Cutter. To view this, click the relevant menu tab or hit space.* ](assets/spookylicense/Untitled%208.png)
<figcaption>The code at 0x1889 showing the error we received. This is the ‘Disassembly’ view of Cutter. To view this, click the relevant menu tab or hit space.</figcaption>
</figure>
...
<figure markdown>
![*Decompiled main function.*](assets/spookylicense/Untitled%209.png)
<figcaption>Decompiled main function.</figcaption>
</figure>
...
<figure markdown>
![*Here’s the flag.*](assets/spookylicense/Untitled%2010.png)
<figcaption>Here’s the output of our script showing a successful flag.</figcaption>
</figure>